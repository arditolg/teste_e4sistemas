...
<body>
    <div class="tabela-container">
        <div class="header">
            <h2 style="float: left;">Lista de Pessoas</h2>
            <h2 style="float: right;"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                ...
                <a href="cad_pessoa.php" style="color: #333;">Cadastrar Pessoa</a></h2>
            <div style="clear: both;"></div> <!-- Limpar flutuação -->
        </div>
        <?php
        require_once("conexao.php");

        $sql = "SELECT id, nome, telefones FROM pessoa";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                $idUsuario = $row["id"];
                $telefonesArray = json_decode($row["telefones"], true);

                echo "<tr class='$classeLinha'>";
                echo "<td>" . $row["nome"] . "</td>";
                if (!empty($telefonesArray)) {
                    $primeiroTelefone = reset($telefonesArray);
                    echo "<td>" . $primeiroTelefone . "</td>";
                } else {
                    echo "<td>Nenhum telefone disponível</td>";
                }
                echo "<td> <a href='edit_pessoa.php?id=" . $row["id"] . "'>
                      ...
                      <a href='excluir_pessoa.php?id=" . $row["id"] . "'>
                        ...
                        <a href='vis_pessoa.php?id=" . $row["id"] . "'>
                            <svg xmlns='http://www.w3.org/2000/svg' height='1em' viewBox='0 0 512 512'>
